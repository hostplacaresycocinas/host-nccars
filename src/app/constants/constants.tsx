export const company = {
  ...
  objectCover: '50%',
  id: 'novelautomotores',
  name: 'Novel Automotores',
  adress: null,
  city: null,
  email: 'novel.automotorescba@gmail.com',
  instagram: 'novel.automotorescba',
  facebook: 'https://www.facebook.com/profile.p',
  whatsapp: ['3515314299', '3513448190'],
  googlemapsLink: null,
  googlemaps: null,
  openDays: null,
  footer:
...
export const metadataCompany = {
  metadataBase: 'https://novelautomotores.vercel.app/',
  title: 'Novel Automotores - Compra y Venta de Autos',
  description:
    'Compra y Venta de Autos: Vehículos seleccionados, atención personalizada.',
};
...
export const sedes = [
  {
    id: 1,
    title: 'Novel Fuerza Aérea',
    adress: 'Av. Fuerza Aérea Argentina 4900',
    city: 'Córdoba',
    tel: null,
    whatsapp: '1122334455',
    schedule: [
      'Lunes a Viernes 9 a 13hs y 14:30 a 18:30hs',
      'Sábados 9 a 13hs',
    ],
    appointment: 'https://maps.app.goo.gl/vgCXUzrq2QU9B7qf6',
    image: 'sede-1.webp',
  },
  {
    id: 2,
    title: 'Novel Aviador Mira',
    adress: 'Aviador Mira 1982',
    city: 'Córdoba',
    tel: null,
    whatsapp: '1122334455',
    schedule: [
    ...
    appointment: 'https://maps.app.goo.gl/oTFQoLYAu74rsTAK8',
    image: 'sede-2.webp',
  },
];
